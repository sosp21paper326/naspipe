...
def model(criterion):
    ...
    return [
        ...
        (stages[3], ["out4", "out5"], ["out6", "out7"]),
        (stages[4], ["out6", "out7"], ["out8", "out9"]),
        (stages[5], ["out8", "out9"], ["out10", "out11"]),
        (stages[6], ["out10", "out11"], ["out12", "out13"]),
        (stages[7], ["out12", "out13"], ["out14"]),
